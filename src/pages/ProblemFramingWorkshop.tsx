...
const ProblemFramingWorkshop = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Pre & Post Workshop Checklist */}
      <section className="py-16 bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">
              Pre- & Post-Workshop <span className="text-primary">Checkliste</span>
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="border-border">
                <CardContent className="p-6 space-y-4">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Ziel & Teilnehmer fixiert</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>Relevante Daten/Insights gebündelt</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>Raum/Board vorbereitet</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>Timeboxes und Rechte geklärt (Decider!)</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border-border">
                <CardContent className="p-6 space-y-4">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>One-Pager teilen</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>To-dos mit Ownern/Terminen erstellen</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>Sprint-Slot buchen</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>Tester:innen rekrutieren</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>Systeme/Accounts vorbereiten</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
