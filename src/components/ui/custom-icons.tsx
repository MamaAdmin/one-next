...
// BMAD Module Icons
export const BMADSessionIcon = (props: IconProps) => (
  <svg
    width="100"
    height="100"
    viewBox="0 0 100 100"
    ...
    {...props}
  >
    <circle cx="50" cy="35" r="20" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <path d="M 35 45 Q 35 55 45 55" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M 65 45 Q 65 55 55 55" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <circle cx="43" cy="32" r="3" fill="currentColor"/>
    <circle cx="57" cy="32" r="3" fill="currentColor"/>
    <line x1="50" y1="55" x2="50" y2="70" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="30" y1="70" x2="70" y2="70" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);

export const BMADArtifactIcon = (props: IconProps) => (
  <svg
    width="100"
    height="100"
    viewBox="0 0 100 100"
    ...
    {...props}
  >
    <rect x="25" y="25" width="50" height="50" rx="4" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <line x1="50" y1="25" x2="50" y2="75" stroke="currentColor" strokeWidth="2.5"/>
    <line x1="25" y1="50" x2="75" y2="50" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="37.5" cy="37.5" r="4" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="62.5" cy="37.5" r="4" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="37.5" cy="62.5" r="4" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="62.5" cy="62.5" r="4" fill="none" stroke="currentColor" strokeWidth="2.5"/>
  </svg>
);

export const BMADAnalyticsIcon = (props: IconProps) => (
  <svg
    width="100"
    height="100"
    viewBox="0 0 100 100"
    ...
    {...props}
  >
    <line x1="20" y1="75" x2="80" y2="75" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="20" y1="75" x2="20" y2="25" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <polyline points="25,60 35,50 45,55 55,40 65,45 75,30" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
...
// BMAD Agent Role Icons
export const AnalystIcon = (props: IconProps) => (
  <svg
    width="100"
    height="100"
    viewBox="0 0 100 100"
  ...
  >
    ...
    <line x1="50" y1="25" x2="50" y2="15" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="50" y1="75" x2="50" y2="85" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="25" y1="50" x2="15" y2="50" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="75" y1="50" x2="85" y2="50" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="32" y1="32" x2="25" y2="25" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="68" y1="68" x2="75" y2="75" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="68" y1="32" x2="75" y2="25" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="32" y1="68" x2="25" y2="75" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);

export const ManagerIcon = (props: IconProps) => (
  <svg
    width="100"
    height="100"
    viewBox="0 0 100 100"
    ...
    {...props}
  >
    <rect x="20" y="20" width="60" height="60" rx="4" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <line x1="35" y1="20" x2="35" y2="80" stroke="currentColor" strokeWidth="2.5"/>
    <line x1="50" y1="20" x2="50" y2="80" stroke="currentColor" strokeWidth="2.5"/>
    <line x1="65" y1="20" x2="65" y2="80" stroke="currentColor" strokeWidth="2.5"/>
    ...
    <line x1="20" y1="65" x2="80" y2="65" stroke="currentColor" strokeWidth="2.5"/>
  </svg>
);

export const UXIcon = (props: IconProps) => (
  <svg
    width="100"
    height="100"
    viewBox="0 0 100 100"
    ...
    {...props}
  >
    <path d="M 30 25 L 50 50 L 30 75" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M 70 25 L 50 50 L 70 75" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <circle cx="30" cy="25" r="5" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="70" cy="25" r="5" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="30" cy="75" r="5" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="70" cy="75" r="5" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="50" cy="50" r="8" fill="none" stroke="currentColor" strokeWidth="2.5"/>
  </svg>
);

export const OwnerIcon = (props: IconProps) => (
  <svg
    width="100"
    height="100"
    viewBox="0 0 100 100"
    ...
    {...props}
  >
    <rect x="25" y="20" width="50" height="60" rx="4" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <polyline points="35,40 42,47 60,30" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <line x1="35" y1="55" x2="65" y2="55" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="35" y1="65" x2="55" y2="65" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);
...
export const ArchitectIcon = (props: IconProps) => (
  <svg
    ...
    {...props}
  >
    <rect x="35" y="25" width="30" height="20" rx="3" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <rect x="20" y="60" width="25" height="20" rx="3" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <rect x="55" y="60" width="25" height="20" rx="3" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <line x1="50" y1="45" x2="32.5" y2="60" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="50" y1="45" x2="67.5" y2="60" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);

export const ScrumIcon = (props: IconProps) => (
  <svg
    width="100"
    height="100"
    viewBox="0 0 100 100"
  ...
  >
    <circle cx="50" cy="50" r="25" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <polyline points="50,30 50,50 65,50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M 65 40 L 75 50 L 65 60" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const DeveloperIcon = (props: IconProps) => (
  <svg
    ...
    {...props}
  >
    <polyline points="35,30 20,50 35,70" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <polyline points="65,30 80,50 65,70" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <line x1="55" y1="25" x2="45" y2="75" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);
...
export const QAIcon = (props: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M 50 25 L 70 40 L 65 65 L 35 65 L 30 40 Z" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round"/>
    <polyline points="40,50 47,57 62,42" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <line x1="50" y1="65" x2="50" y2="75" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="40" y1="75" x2="60" y2="75" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);

export const OrchestratorIcon = (props: IconProps) => (
  <svg
    width="100"
    height="100"
    viewBox="0 0 100 100"
  ...
  >
    <circle cx="50" cy="50" r="8" fill="currentColor"/>
    <circle cx="25" cy="25" r="6" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="75" cy="25" r="6" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="25" cy="75" r="6" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <circle cx="75" cy="75" r="6" fill="none" stroke="currentColor" strokeWidth="2.5"/>
    <line x1="50" y1="50" x2="28" y2="28" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="50" y1="50" x2="72" y2="28" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="50" y1="50" x2="28" y2="72" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="50" y1="50" x2="72" y2="72" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);
