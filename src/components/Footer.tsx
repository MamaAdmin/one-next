      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            <InlineTextArea
              value={content.company_description || 'Ihr Partner für individuelle KI-Entwicklung. Wir begleiten Ihre Idee strukturiert bis zur Umsetzungsreife – von der Problemdefinition bis zum fertigen Konzept.'}
