...
import expertiseImage from "@/assets/expertise-consultation.jpg";
import efficiencyImage from "@/assets/efficiency-technology.jpg";
    ...
    <section className="py-16 bg-[#fff0ed]">
      <div className="container mx-auto px-6">
          ...
          <div className="bg-secondary rounded-[2rem] overflow-hidden">
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="h-64 md:h-auto">
                <img src={expertiseImage} alt="Expertise" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>

          {/* Effizienz Card */}
          <div className="bg-foreground text-background rounded-[2rem] overflow-hidden">
            <div className="grid md:grid-cols-2 gap-0">
              <div className="h-64 md:h-auto order-2 md:order-1">
                <img src={efficiencyImage} alt="Effizienz" className="w-full h-full object-cover" />
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="rounded-[2rem] overflow-hidden bg-[#b0a377]">
            <div className="grid grid-rows-[auto_1fr] h-full">
              <div className="h-64">
                <img src={successImage} alt="Erfolg" className="w-full h-full object-cover" />
              </div>
              <div className="p-8 md:p-12 space-y-6 flex flex-col justify-center">
                <InlineTextField
